...
export default async function VoluntariosPage({
  ...
  const [helpNeeded, allVolunteers, myVolunteer] = await Promise.all([
    // TODO: Restringir a usuarios validados/admin cuando exista verificación de responsables de proyecto (§9)
  ...
  return (
    <main className="min-h-screen px-s3 py-s5 lg:px-s7 lg:py-s7">
      <div className="max-w-4xl mx-auto">
        ...
        {/* TODO: Restringir a validados/admin cuando exista verificación de responsables (§9) */}
        <section className="mb-s7">
          <h2 className="font-serif text-xl font-bold mb-s3">
            Apps que buscan apoyo
          </h2>
          {helpNeeded.length === 0 ? (
            <p className="text-muted/60 text-sm">
